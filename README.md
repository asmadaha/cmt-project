...
Three PNG figures are stored in the "results/figures/" directory:
  * coop_time_multiple_noise.png : cooperation over time for all noise levels on a single plot
  * final_coop_vs_noise.png : long-term cooperation as a function of noise probability
